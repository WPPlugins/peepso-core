...
<div class="ps-widget--members__wrapper ps-widget__wrapper<?php echo $instance['class_suffix']; ?> ps-widget<?php echo $instance['class_suffix']; ?>">
			...
			if (count($instance['list'])) {
				...
				<ul class="ps-list-thumbnail">
					...
					foreach ($instance['list'] as $user) {
						...
						$PeepSoMemberSearch->show_latest_member(PeepSoUser::get_instance($user));
						echo '</li>';
					}
					?>
				</ul>
				...
				echo "<span class='ps-text--muted'>" . __('No latest members', 'peepso-core') . "</span>";
			}
